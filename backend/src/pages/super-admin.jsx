...
export default function SuperAdmin() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    setStatus("");
    const res = await fetch("/api/hr/super-admin/create-rh", {
      method: "POST",
      headers: {
    ...
    setStatus(data.success ? "Compte RH créé avec succès!" : data.error);
    if (data.success) {
      setForm({
        rhId: "",
        lastName: "",
  ...
  return (
    <>
      <style>{`
        ...
        .superadmin-input-row {
          margin-bottom: 18px;
        }
        .superadmin-input-wrapper {
          position: relative;
          display: flex;
          align-items: center;
        }
        ...
        .superadmin-password-row {
          display: flex;
          align-items: center;
        }
        .superadmin-password-toggle {
          background: none;
          border: none;
          margin-left: -36px;
          cursor: pointer;
        ...
        @media (max-width: 500px) {
          .superadmin-card { padding: 18px 6px 16px 6px; }
        }
        .superadmin-header {
          width: 100vw;
          background: linear-gradient(90deg, #e51c23 0%, #b71c1c 100%);
      ...
      <div className="superadmin-bg">
        <div className="superadmin-center">
          <div className="superadmin-card">
            ...
            />
            <div className="superadmin-title">Super Admin</div>
            <div className="superadmin-subtitle">Créer un compte RH</div>
            <form onSubmit={handleSubmit} autoComplete="off">
              <div className="superadmin-input-row">
                <label className="superadmin-label" htmlFor="rhId">Identifiant RH *</label>
              ...
              <div className="superadmin-input-row">
                <label className="superadmin-label" htmlFor="lastName">Nom *</label>
                <div className="superadmin-input-wrapper">
                  <input
                    className="superadmin-input"
                    type="text"
              ...
              <div className="superadmin-input-row">
                <label className="superadmin-label" htmlFor="firstName">Prénom *</label>
                <div className="superadmin-input-wrapper">
                  <input
                    className="superadmin-input"
                    type="text"
              ...
              <div className="superadmin-input-row">
                <label className="superadmin-label" htmlFor="password">Mot de passe *</label>
                <div className="superadmin-input-wrapper" style={{ position: "relative" }}>
                  <input
                    className="superadmin-input"
              ...
              <button className="superadmin-btn" type="submit">
                Créer le compte RH
              </button>
              {status && (
                <div className={`superadmin-status${status.toLowerCase().includes("succès") ? "" : " error"}`}>
                  {status}
                </div>
              )}
            </form>
